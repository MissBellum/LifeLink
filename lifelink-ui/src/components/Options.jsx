...
function Options(props) {
  const helpList = props.options?.map((option) => (
    <div
      id={option.id}
      key={option.id}
      className="options__item bg-white rounded-lg shadow-lg p-3 transform hover:scale-105 hover:cursor-pointer transition-transform duration-300 ease-out hover:shadow-2xl mb-2">
